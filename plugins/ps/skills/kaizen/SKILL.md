...
`/ps:kaizen [lens]` — optional lens focuses today's pick (`dx`, `ci`, `deploy`, `code`, `tests`, `security`, `deps`, `docs`). With no arg, sweep all lenses balanced and let the ledger rotate coverage.
